...
class OrderModel(models.Model):
    book = models.ForeignKey('GoodModel', on_delete=models.CASCADE, verbose_name='所属商品')
...
class HotModel(models.Model):
    name = models.CharField(max_length=100, verbose_name='名称')
    book = models.ForeignKey('GoodModel', on_delete=models.CASCADE, verbose_name='热门商品')
